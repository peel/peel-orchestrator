...
**If no worktree path is set:** You work in the main checkout. Only one bean runs in the main checkout at a time — no coordination needed.
...
```bash
cd {BEANS_ROOT} && beans update {BEAN_ID} --body-append "..."
```
