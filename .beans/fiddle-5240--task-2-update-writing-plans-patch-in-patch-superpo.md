...
updated_at: 2026-03-14T18:36:54Z
parent: fiddle-9qn1
blocked_by:
    - fiddle-fabu
---
...
2. In Step 4 (Patch Writing-Plans, formerly Step 3), add sub-step 4c before current handoff update (which becomes 4d):
   ...
   - If present: STOP, report "Plan complete. Beans created. Returning control to orchestrate."
   - If absent: proceed to Execution Handoff
3. Update verify step (Step 6) to include orchestrate context check in writing-plans checklist
4. Commit

Acceptance criteria:
- Writing-plans patch has orchestrate context check sub-step
