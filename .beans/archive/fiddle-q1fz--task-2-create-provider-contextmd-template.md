...
updated_at: 2026-03-15T14:04:28Z
parent: fiddle-jj30
---
...
2. Verify: all placeholders use {UPPER_SNAKE_CASE} format. File is in skills/develop-subs/roles/ alongside implementer.md and reviewer.md.
3. Commit: git commit -m "feat: add provider context template for standardized handoff"

Acceptance criteria:
- File exists at skills/develop-subs/roles/provider-context.md
